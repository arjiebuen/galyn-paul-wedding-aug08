...
export default function DressCode() {
  return (
    <section id="dress-code" className="py-32 bg-[#FAF7F4]">
      <div className="container mx-auto px-6">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-lg mx-auto mb-14 rounded-2xl border-2 border-red-200 bg-red-50/80 px-8 py-5 text-center"
        >
